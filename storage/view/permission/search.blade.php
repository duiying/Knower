            ...
            <form id="user-search" onsubmit="return false;">
                <div class="row">
                    <div class="input-group-append mr-1">
                        <a href="/view/permission/create"><button type="button" class="btn btn-block btn-outline-primary"><i class="fa fa-plus"></i></button></a>
                    </div>
                </div>
            </form>
        </div>
        ...
        function renderPermissionList(param = {})
        {
            ...
            if (data !== false) {
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    listHtml += '</td>';
                    listHtml += '<td>';
                    listHtml += '<a href="/view/permission/update?id=' + list[i].id + '"><i class="fa fa-edit"></i></a>';
                    listHtml += '<a href="javascript:;" class="ml-2" onclick="handlePermissionDelete(' + list[i].id + ')"><i class="fa fa-trash"></i></a>';
                    listHtml += '</td>';
                    listHtml += '</tr>';
                }
