            ...
            <form id="tag-search" onsubmit="return false;">
                <div class="row">
                    ...
                    <div class="input-group-append mr-1">
                        <a href="/view/tag/create"><button type="button" class="btn btn-block btn-outline-primary"><i class="fas fa-plus"></i></button></a>
                    </div>
                    <div class="col-3">
        ...
        function renderTagList(param = {})
        {
            ...
            if (data !== false) {
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    listHtml += '<td>';
                    listHtml += '<a href="/view/tag/update?id=' + list[i].id + '"><i class="fas fa-edit"></i></a>';
                    if (list[i].root != 1) {
